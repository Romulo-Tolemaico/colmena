...
-- Ejecutar con: docker exec -i colmena-db psql -U colmena -d colmena < scripts/seed_data.sql
-- ============================================================

-- Zonas protegidas (polígonos simplificados en la región norte de Bolivia)
...
INSERT INTO normativa (codigo, titulo, texto_resumen) VALUES
    ('b1b2c3d4-1111-4111-8111-111111111111', 'Ley 1333 - Ley de Medio Ambiente', 'Establece el marco regulatorio para la protección del medio ambiente en Bolivia.'),
    ('b1b2c3d4-2222-4222-8222-222222222222', 'D.S. 28592 - Reglamento Ambiental Minero', 'Regula las actividades mineras y sus impactos ambientales.'),
    ('b1b2c3d4-3333-4333-8333-333333333333', 'Código Penal art. 216', 'Sanciones penales por daño ambiental y extracción ilegal.');

-- Reportes ficticios (8 reportes en diferentes ubicaciones y estados)
...
-- Contacto informante (algunos anónimos, otros con contacto)
...
INSERT INTO notas_reporte (reporte_codigo, texto) VALUES
    ...
    ('c1000001-0005-4005-8005-000000000005', 'Draga grande operando de noche. Se escucha motor a distancia.'),
    ('c1000001-0007-4007-8007-000000000007', 'Dos dragas medianas operando en paralelo.'),
    ('c1000001-0008-4008-8008-000000000008', 'Operación a gran escala con múltiples equipos y vehículos en la orilla.');

-- Evaluaciones del agente (resultado del análisis)
